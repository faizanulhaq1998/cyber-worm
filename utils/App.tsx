...
const App: React.FC = () => {
  ...
  const handleTradeAction = useCallback((type: ContractType) => {
    ...
    // New API Call
    api.proposal(selectedMarket, type);

  }, [isAuthorized, selectedMarket, resetTradeState]);
  ...
  }, [processTick, selectedMarket, resetTradeState]);
              ...
              <div className="w-full bg-black/90 border-2 rounded-lg p-5 animate-pulse flex justify-between items-center shadow-[0_0_30px_rgba(0,255,234,0.3)]" style={{ borderColor: theme.primary }}>
                ...
                <div className="text-right">
                    ...
                    <div className="flex gap-4 items-end">
                      ...
                      <span className="text-2xl font-black leading-none" style={{ color: theme.primary }}>T-{trade.ticksLeft}</span>
                    </div>
                </div>
              </div>
            )}
